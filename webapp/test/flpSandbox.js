		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#pricingworkflow-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pricingworkflow-display": {
								"semanticObject": "pricingworkflow",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pricingworkflow",
									"url": sap.ui.require.toUrl("pricingworkflow")
								}
							}
						}
					}
